...
# 获取并保存 scaling factor 值，供二阶段使用
scaling_factor_value = model.model.scaling_factor.numpy()
scaling_save_path = os.path.join(os.path.dirname(__file__), "scaling_factor_vgg.npy")
np.save(scaling_save_path, scaling_factor_value)
print('scaling_factor_value：', scaling_factor_value)
print(f"scaling_factor saved to: {scaling_save_path}")
print('start testing...')
