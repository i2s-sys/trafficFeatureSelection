...
class Resnet():
    def __init__(self,K,ES_THRESHOLD,seed,l1F, lossType, beta, gamma):
        self.K = K
    ...
    def build_loss(self):
        l1_regularizer = tf.keras.regularizers.l1(self.l1F)
    ...
    def train(self):
        ...
        # self.scaling_factors_history.append(self.sess.run(self.scaling_factor))  # 记录当前epoch的选择因子
