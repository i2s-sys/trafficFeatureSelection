...
class AE():
    ...
    def create_AE(self):
        ...
        scaled_input = tf.multiply(self.x_input, self.scaling_factor)
        self.encoded = layers.Dense(128, activation='relu')(scaled_input)
    ...
    def build_loss(self):
        ...
        self.loss = tf.sqrt(tf.reduce_mean(tf.square(self.x_input - self.output))) + regularization_penalty
