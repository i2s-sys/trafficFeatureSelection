...
# 全量特征，缩放因子固定：加载一阶段保存的 scaling_factor_vgg.npy，取最大32，其余置零
scaling_path = os.path.join(os.path.dirname(__file__), "scaling_factor_vgg.npy")
...
selected_features = list(range(DATA_DIM))
vgg2 = VGG2("ce",dim=DATA_DIM, selected_features=selected_features,seed=SEED, fixed_scaling=fixed_scaling)
